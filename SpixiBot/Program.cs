...
namespace SpixiBot
{
    class Program
    {
        ...
        static void onStart(string[] args)
        {
            ...
            Console.WriteLine(string.Format("Spixi Bot {0} ({1})", Config.version, CoreConfig.version));
            ...
            if (ConsoleHelpers.verboseConsoleOutput)
                Console.WriteLine("-----------\nPress Ctrl-C or use the /shutdown API to stop the Spixi Bot process at any time.\n");
        }
        ...
        static void onStop()
        {
            ...
            {
                Console.WriteLine("");
                Console.WriteLine("Spixi Bot stopped.");
            }
        }
    }
}
